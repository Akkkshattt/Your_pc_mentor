...
export default function HomeContainer() {
  return (
    ...
    <div className=" flex flex-col items-start  justify-center gap-2">
        ...
        <p className="text-left md:text-left md:w-[80%]">
    ...
    <div className='grid grid-cols-2 absolute top-20 right-10'>
      <img src={Custompc1} alt="" className='relative h-300 w-300 -top-24 right-24 rounded-md'/>
      <img src={Service1} alt="" className='relative h-300 w-300 -top-24 right-3 rounded-md'/>
      {/* <img src={Custompc1} alt="" className='relative -top-10 right-72'/> */}
    </div>
    <div className='grid grid-cols-2 absolute top-20 right-10'>
    <img src={Service2} alt="" className='relative h-300 w-300 top-52 right-24 rounded-md'/>
